<x-lareon::admin-editor-layout type="update"  :instance="$post">
    ...
    @section('form')
        ...
        <x-lareon::sections.slug :value="old('slug') ?? $post->slug" name="slug" :placeholder="__('enter a unique :title',['title'=>__('slug')])" :required="true"/>
    ...
    @section('aside')
        ...
        <x-tag::sections.tag :value=" old('tags') ?? $post->tags->pluck('id')->toArray()"/>
