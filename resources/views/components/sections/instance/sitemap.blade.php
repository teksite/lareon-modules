...
<section>
    <fieldset class="fieldset">
        ...
        <div class="mb-6">
            <x-lareon::dynamic.single name="seo[sitemap][image]" :title="__('image')" :value="old('seo.sitemap.image') ?? $data['image']  ?? []"/>
            <x-lareon::input.error  :message="get_error($errors , 'seo[sitemap][image]')"/>
            <x-lareon::input.error  :message="get_error($errors , 'seo[sitemap][image][*]')"/>
        </div>
